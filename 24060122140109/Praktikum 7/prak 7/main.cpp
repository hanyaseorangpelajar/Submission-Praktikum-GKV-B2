...
void drawScene() {
    ...
    // Bind texture for all sides
    glEnable(GL_TEXTURE_2D);
    glBindTexture(GL_TEXTURE_2D, _textureId);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);

    // Draw all sides of the cube with the same texture
    glBegin(GL_QUADS);
    // Top side
...
glutCreateWindow("Jeremia Joel Richard Ramalael - 24060122140109");
initRendering();
