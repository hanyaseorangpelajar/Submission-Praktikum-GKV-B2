...
void Mobil() {
    // Badan mobil
    glPushMatrix();
    glColor3f(0.8f, 0.0f, 0.0f); // Warna merah untuk badan mobil
    glTranslatef(0.0f, 1.5f, 0.0f);
    glScalef(6.0f, 3.0f, 2.0f); // Skala ukuran badan mobil
    glutSolidCube(1.0);
    glPopMatrix();

    // Roda 1
    glPushMatrix();
    glColor3f(0.2f, 0.2f, 0.2f); // Warna abu-abu untuk roda
