...
void keyboard(unsigned char k, int x, int y)
{
	...
	{
	case 'd':
		rotAngle += 50; // increase rotation by 5 degrees
		break;
	case 'w':
		rotAngle1 += 50; // increase rotation by 5 degrees
		break;
	case 's':
		rotAngle1 -= 50; // increase rotation by 5 degrees
		break;
	case 'a':
		rotAngle -= 50; // decrease rotation by 5 degrees
		break;
	case 'q':
		exit(0); // exit
	}
...
int main()
{
	...
	glutCreateWindow("Teko"); // create the window
